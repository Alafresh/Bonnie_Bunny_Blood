...
public class Pathfinding : MonoBehaviour
{
    ...
    private List<PathNode> GetNeighbourList(PathNode currentNode)
    {
        ...
        {
            totalNeighbourList.Add(GetNode(
    ...
    private List<GridPosition> GetPathfindingLinkConnectedGridPositionList(GridPosition gridPosition)
    {
        ...
        foreach (PathfindingLink pathfindingLink in pathfindingLinksList)
        {
    ...
    public bool IsWalkableGriPosition(GridPosition gridPosition)
    {
        return GetGridSystem(gridPosition.floor).GetGridObject(gridPosition).IsWalkable();
    }
    
    public void SetIsWalkableGriPosition(GridPosition gridPosition, bool isWalkable)
    {
